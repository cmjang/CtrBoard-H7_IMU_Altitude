...
<package xmlns:xs="http://www.w3.org/2001/XMLSchema-instance" schemaVersion="1.0" xs:noNamespaceSchemaLocation="PACK.xsd">
  ...
  <generators>
    <generator id="STM32CubeMX_CM7" Gvendor="STMicroelectronics" Gtool="STM32CubeMX" Gversion="6.4.0">
      ...
      <project_files>
        <file category="include" name="../../STM32CubeMX/STCubeGenerated/CM7/Inc/"/>
        <file category="source" name="../../STM32CubeMX/STCubeGenerated/CM7/Src/main.c" />
        <file category="header" name="../../STM32CubeMX/STCubeGenerated/CM7/Inc/stm32h7xx_it.h"/>
        <file category="source" name="../../STM32CubeMX/STCubeGenerated/CM7/Src/stm32h7xx_it.c"/>
      </project_files>
    </generator>
  </generators>
  <taxonomy>
...
[#if ipsInfo.mxcontextname?contains("M7")]
...
[/#if]
  ...
  <components>
    <component generator="STM32CubeMX_CM7" Cvendor="Keil" Cclass="Device" Cgroup="STM32Cube Framework" Csub="STM32CubeMX" Cversion="2.0.0" condition="STCubeMX">
      ...
      <files>
        ...
        <file category="header" name="../../STM32CubeMX/STCubeGenerated/CM7/Inc/stm32h7xx_hal_conf.h"/>
        [#if peripheralParams.get("RCC")??]
          [#if peripheralParams.get("RCC").get("driver") == ("HAL")]
        <file category="source" name="../../STM32CubeMX/STCubeGenerated/CM7/Src/stm32h7xx_hal_msp.c"/>
          [/#if]
        [/#if]
[#if timebase_tim == true]
        <file category="source" name="../../STM32CubeMX/STCubeGenerated/CM7/Src/stm32h7xx_hal_timebase_tim.c"/>
[/#if]
      </files>
    </component>
  </components>
